...
var _getMonthViewHeaderText = require('./japaneseLanguageUtilities/getMonthViewHeaderText');
...
var MonthView = React.createClass({
    ...
    handleClick: function handleClick(props, date, timestamp, event) {
        if (props.minDate && timestamp < props.minDate || props.maxDate && timestamp > props.maxDate) {
            return;
        }
...
MonthView.getHeaderText = _getMonthViewHeaderText.getMonthViewHeaderText;
